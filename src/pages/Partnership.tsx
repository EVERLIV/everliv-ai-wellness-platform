...
import { Building, UserPlus, Stethoscope, TrendingUp, CheckCircle } from 'lucide-react';
// Import Handshake icon from a custom file since it's not in lucide-react core
