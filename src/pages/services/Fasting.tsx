...
const Fasting = () => {
  ...
  // Создаем benefits для ServicePageLayout
  const benefitsArray = [
    {
      title: "Аутофагия",
      description: "Запуск процессов очищения клеток от поврежденных компонентов",
      icon: <CheckCircle className="h-10 w-10" />
    },
    {
      title: "Метаболическая гибкость",
      description: "Улучшение способности организма переключаться между источниками энергии",
      icon: <CheckCircle className="h-10 w-10" />
    },
    {
      title: "Снижение воспаления",
      description: "Уменьшение воспалительных процессов в организме",
      icon: <CheckCircle className="h-10 w-10" />
    },
    {
      title: "Регенерация",
      description: "Активизация процессов восстановления и омоложения",
      icon: <CheckCircle className="h-10 w-10" />
    }
  ];

  const intermittentFastingContent = (
  ...
  const fastingProtocols = (
    <div className="space-y-8">
      <Tabs defaultValue="intermittent">
        ...
        <TabsContent value="intermittent">{intermittentFastingContent}</TabsContent>
        <TabsContent value="extended">{extendedFastingContent}</TabsContent>
        <TabsContent value="mimicking">{fastingMimickingContent}</TabsContent>
      </Tabs>
    </div>
  );
  ...
  const scientificBackground = (
    <>
      ...
      <div className="prose max-w-none">
        <h3>Научное обоснование голодания</h3>
        <p>
          Многочисленные исследования показывают, что периодическое голодание активирует аутофагию - 
          важнейший внутриклеточный процесс переработки поврежденных компонентов клетки. 
          Кроме того, голодание способствует улучшению чувствительности к инсулину, 
          нормализации уровня глюкозы в крови и работы митохондрий.
        </p>
      </div>
    </>
  );
  ...
  const faqs = [
    {
      question: "Сколько дней нужно голодать для получения пользы?",
      answer: "Даже короткие периоды голодания от 16-24 часов могут принести пользу. Для большинства людей оптимальным вариантом будет регулярное интервальное голодание 16:8 или периодические 24-часовые голодания."
    },
    {
      question: "Можно ли пить воду во время голодания?",
      answer: "Да, во время голодания необходимо пить достаточное количество воды. Также допускается употребление несладкого чая и черного кофе без добавок."
    },
    {
      question: "Подходит ли голодание для снижения веса?",
      answer: "Да, различные протоколы голодания могут быть эффективны для снижения веса, однако важно подобрать оптимальный режим и следовать принципам здорового питания в периоды приема пищи."
    }
  ];
  ...
  return (
    <ServicePageLayout
      hero={{
        ...
        subtitle: "Путь к омоложению и исцелению",
        description: "Научно обоснованные протоколы голодания для оздоровления, регенерации и улучшения метаболического здоровья",
        imageSrc: "/placeholder.svg"
      }}
      benefits={benefitsArray}
      scientificBackground={scientificBackground}
      protocols={fastingProtocols}
      casesStudies={ctaSection}
      faq={faqs}
    />
  );
};
