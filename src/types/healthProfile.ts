...
export interface HealthProfileData {
  ...
  moodChanges?: 'stable' | 'mild_changes' | 'moderate_changes' | 'significant_changes';
  mentalHealthSupport?: 'none' | 'family_friends' | 'professional' | 'medication';
  
  // Lifestyle
  smokingStatus?: 'never' | 'former' | 'current_light' | 'current_moderate' | 'current_heavy';
