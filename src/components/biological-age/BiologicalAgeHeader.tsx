...
interface BiologicalAgeHeaderProps {
  onAddAnalysis: (category: string) => void;
}

const BiologicalAgeHeader: React.FC<BiologicalAgeHeaderProps> = ({
  onAddAnalysis,
}) => {
  const navigate = useNavigate();

  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-blue-50 border-b border-gray-200">
...
export default BiologicalAgeHeader;
