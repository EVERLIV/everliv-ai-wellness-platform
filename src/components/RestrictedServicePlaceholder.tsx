  ...
  return <div className="min-h-screen flex flex-col">
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-sm border border-gray-200 my-[70px]">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              {isTrialActive ? <div className="bg-primary/5 p-4 rounded-lg mb-8 max-w-md">
                ...
                </div> : <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  <Button size="lg" onClick={() => navigate('/signup')} className="min-w-[180px]">
                    Начать бесплатно
                  </Button>
