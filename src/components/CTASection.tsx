...
export default function CTASection() {
  return (
    <section className="hero-gradient py-16 md:py-20 relative overflow-hidden">
      {/* Decorative Elements */}
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-accent opacity-20 rounded-full blur-2xl translate-y-1/3 -translate-x-1/3"></div>
      <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 opacity-20 rounded-full blur-3xl -translate-y-1/3 translate-x-1/3"></div>
