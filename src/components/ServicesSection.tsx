...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description, link, benefits }) => (
  ...
  const services = [
    {
      ...
      benefits: [
        ...
        "Гормезис и адаптация организма"
      ]
    },
    {
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-secondary mb-4">Наши сервисы</h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Комплексный научный подход к продлению здоровой и активной жизни через проверенные методики и индивидуальные программы
          </p>
        </div>
