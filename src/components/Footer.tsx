        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Комплексная технологическая платформа для здоровья на базе искусственного интеллекта
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-everliv-600">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-800">Платформа</h3>
            <ul className="space-y-3">
              <li><Link to="/features" className="text-gray-600 hover:text-everliv-600">Возможности</Link></li>
