...
serve(async (req) => {
  ...
  try {
    ...
    if (conversationHistory && conversationHistory.length > 0) {
      const recentHistory = conversationHistory.slice(-8); // Увеличиваем историю до 8 сообщений
