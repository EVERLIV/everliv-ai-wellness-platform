...
ВАЖНО: Отвечай только чистым HTML кодом без markdown блоков и тегов \`\`\`html.
...
При получении медицинских данных проанализируй их согласно структуре выше и предоставь развернутый, понятный ответ в HTML формате.
