...
- Основывайся на российских клинических рекомендациях Минздрава РФ
- Учитывай российские нормы лабораторных показателей
- Включи конкретные дозировки, протоколы, временные рамки
- Добавь предупреждения о безопасности и противопоказания
- Ссылайся на российские медицинские источники и препараты
    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'Ты ведущий эксперт по превентивной медицине и биохакингу, специализирующийся на российской медицинской практике. Основываешь рекомендации на клинических рекомендациях Минздрава РФ, российских нормах лабораторных показателей и доступных в России препаратах. Создаваешь персональные рекомендации высочайшего качества на основе целей пользователя. Отвечай только валидным JSON без markdown разметки.'
          },
          {
            role: 'user',
            content: prompt
